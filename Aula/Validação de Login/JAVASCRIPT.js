class Validator {
    ...
    validate(form){
        ...
        inputs.Array.forEach(function(input,obj){
        
            
            //fazer validaão de acordo com o atributo do input
            for(let it=0; this.validations.length> inputs; i++){
